...
class CShadowEquipController {
    ...
    #changeShadowItem(objEquipBlock, newValue) {
        ...
        for (let idx = 0; (idx < rndOptTypeList.length) && (idx < rndOptValueList.length); idx++) {
            ...
            // ランダムオプション種別　選択欄
            HmRndopt.SetUpRndOptKind(objRndOptType, rndOptListId);
...
globalThis.g_shadowEquipController = new CShadowEquipController();
globalThis.g_shadowEquipController.initializeHTML();
